  ...
  return (
    <SlideWrapper>
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-4xl space-y-16">
        <FadeUp delay={0.2}>
          <div ref={handRef}>
            <Hand className="w-14 h-14 text-lava/60" strokeWidth={1.5} />
          </div>
        </FadeUp>
        ...
        <FadeUp delay={0.8}>
          <p className="text-2xl md:text-3xl text-depth-subtle mt-2">
        ...
        <BlurReveal delay={1.2}>
          <div className="flex items-center gap-4 pt-4">
            <span className="text-amber-accent text-xl tracking-wide">Carrera</span>
            <span className="text-[#6a6a7a]">/</span>
            <span className="text-amber-accent text-xl tracking-wide">Curso</span>
            <span className="text-[#6a6a7a]">/</span>
            <span className="text-amber-accent text-xl tracking-wide">Autodidacta</span>
          </div>
        </BlurReveal>
      </div>
    </SlideWrapper>
