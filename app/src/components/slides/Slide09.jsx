  ...
  return (
    <SlideWrapper>
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-4xl space-y-14">
        <FadeUp delay={0.2}>
          <p className="text-xl text-depth-subtle">
        ...
        <ScaleIn delay={0.5}>
          <div className="flex items-center gap-6 mt-6">
            <TrendingDown className="w-10 h-10 text-lava/80" strokeWidth={1.5} />
            <div>
              <NumberTicker value={67} delay={0.6} suffix="%" className="text-6xl md:text-8xl font-black font-display text-depth-accent" />
              <p className="text-2xl text-depth mt-4 font-semibold">
                de reducción
              </p>
            </div>
          </div>
        ...
        <BlurReveal delay={1.3}>
          <p ref={noteRef} className="text-[#ccc] text-xl max-w-xl leading-relaxed mt-6" style={{ opacity: 0.7 }}>
