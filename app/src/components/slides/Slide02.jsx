      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-4xl space-y-10">
        <FadeUp delay={0.2}>
          <div className="flex items-center gap-3">
            <Layers className="w-5 h-5 text-lava" strokeWidth={1.5} />
            <span className="text-lava text-base font-medium uppercase tracking-[0.25em]">
              Concepto clave
            </span>
          </div>
        </FadeUp>
        ...
        <ClipReveal delay={0.4}>
          <h2 className="text-5xl md:text-7xl font-extrabold font-display text-depth leading-tight tracking-tight mt-4">
            La importancia del{' '}
        ...
        <FadeUp delay={0.7}>
          <p className="text-xl md:text-2xl text-depth-subtle leading-relaxed max-w-2xl mt-4">
            Acá todos vamos a usar IA, pero busquemos entender lo que estamos haciendo con ella.
          </p>
        </FadeUp>

        <BlurReveal delay={1}>
          <p className="text-amber-accent text-2xl md:text-3xl font-medium leading-relaxed max-w-xl mt-6">
